		...
		client.query(allQueriesForTitanic[0][1], function(err, result) {
			...
			client.query(allQueriesForTitanic[0][2], function(err, result) {
				...
				client.query(allQueriesForTitanic[0][3], function(err, result) {
					...
					console.log(totalOptions[1][0].rows);
					console.log(totalOptions[1][1].rows);
					console.log(totalOptions[1][2].rows);
					console.log(totalOptions[1][3].rows);
...
>>>>>>> e8d3b9deac9d5eff30b57e473e6dd3aefd019411
